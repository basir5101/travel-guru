    ...
    return (
        <div className='container'>
            <form className='travel-form'>
                {
                    user.newUser ?
                        <h4 style={{ color: '#0513d4' }} className='text-center mb-5'>Create New Account</h4> :
                        <h4 style={{ color: '#0513d4' }} className='text-center mb-5'>Log In</h4>
                }
                {
                    user.newUser && <div>
                        <input type="text" name="firstName" onChange={handleInputField} placeholder='First Name' required />
                        <input type="text" name="lastName" onChange={handleInputField} placeholder='Last Lame' required />
                    </div>
                }
                <input type="text" name="email" placeholder='Email' onChange={handleInputField} required />
                <input type="password" name="password" placeholder='Password' onChange={handleInputField} required />
                {
                    user.newUser && <input type="password" name="confirmPassword" onChange={handleInputField} placeholder='Confirm Password' required />
                }
                <br />
                <br />
                {
                    user.newUser ?
                        <button className='btn' disabled={!user.email || !user.password} type='submit' onClick={signUp} variant='warning' >Sign Up</button> :
