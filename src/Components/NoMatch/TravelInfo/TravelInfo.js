            ...
            <div>
                <form className = 'travel-form'>
                    ...
                    <Link to="/booking-info">
                        <Button disabled = {!loggedInUser.starting || !loggedInUser.ending || !loggedInUser.origin || !loggedInUser.destination} onClick = {handleTravel} type = 'submit' variant = 'warning' >Start Booking</Button>
                    </Link>
                </form>
            </div>
        </div>
